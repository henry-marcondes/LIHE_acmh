"""
Django settings for consumo project.
...
WSGI_APPLICATION = 'consumo.wsgi.application'
...
DATABASES = {
    ...
    'mysql_db': {
        ...
        'NAME': os.getenv('DB_NAME', 'consumo'),              # Nome do banco de dados
...
DATABASE_ROUTERS = ['consumo.routers.MySQLRouter']
